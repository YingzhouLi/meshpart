...
%
%   Generate a triple-tree version of the tree-cross-path mesh from Guattery
%   and Miller,  "On the performance of spectral graph partitioning
%   methods," SODA 1995.
%
%   [A,xyz] = tree3xpath(n) The generated mesh has about n vertices.
%   Outputs:  A is the Laplacian; xyz is coordinates for a drawing.
%
%   [A,xyz] = tree3xpath(dep,len) The tree has depth "dep" and the path has
%   length "len", so the whole mesh has (3*2^dep - 2)*len vertices.
%
%   See also TREEXPATH.
