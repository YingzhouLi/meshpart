...
%                 spectral bisection algorithm of Simon et al: Label the
%                 vertices with the components of the Fiedler vector (the
%                 second eigenvector of the Laplacian matrix) and partition
